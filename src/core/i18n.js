...
export const STRINGS = {
  en: {
    ...
    'track.grammar': 'Grammar', 'track.vocab': 'Vocabulary',
    'common.done': 'Done',
    'write.title': 'Writing practice',
    'write.sub': 'Write it yourself, then mark your own work against a checklist. There is no automatic grader — and there is no model answer until after you have marked yourself.',
    'write.prompt': 'The task',
    'write.placeholder': 'Write your answer here…',
    'write.words': '{n} words · aim for {min}',
    'write.done': "I've finished",
    'write.checklist': 'Mark your own work',
    'write.checklistSub': 'Read your text again and tick only what is actually true of it. Nobody sees this, and ticking more boxes does not earn more.',
    'write.showModel': 'Show a model answer',
    'write.selfScore': 'Your own marking',
    'write.selfScoreSub': 'This is your judgement, not a grade. The unticked items are your next writing goals.',
    'write.model': 'A model answer',
    'write.back': 'Back to the prompts',
    'write.state.new': 'Not started',
    'write.state.draft': 'Draft saved',
    'write.state.done': 'Marked',
    'unit.write': 'Write', 'unit.writeDesc': 'Free writing with a self-assessment checklist',
    'net.offline': 'You are offline. Lessons you have already opened still work.',
    'set.offline': 'Offline use',
    'set.offlineDesc': 'Download every lesson now so the whole course works with no connection. Under one megabyte, kept in this browser.',
    'set.offlineGet': 'Download all lessons',
    'set.offlineProgress': 'Downloading… {done}/{total}',
    'set.offlineDone': '✓ All {total} files saved ({mb} MB). The course now works offline.',
    'set.offlinePartial': '{ok} of {total} files saved. Try again when the connection is better.',
  ...
  ar: {
    ...
    'track.grammar': 'القواعد', 'track.vocab': 'المفردات',
    'common.done': 'تم',
    'write.title': 'تدريب الكتابة',
    'write.sub': 'اكتب بنفسك ثم صحّح عملك بقائمة تحقّق. لا يوجد مصحّح آلي، ولا تظهر الإجابة النموذجية إلا بعد أن تصحّح لنفسك.',
    'write.prompt': 'المطلوب',
    'write.placeholder': 'اكتب إجابتك هنا…',
    'write.words': '{n} كلمة · المستهدف {min}',
    'write.done': 'انتهيت',
    'write.checklist': 'صحّح عملك بنفسك',
    'write.checklistSub': 'أعد قراءة نصّك وضع علامة على ما ينطبق عليه فعلاً. لا يطّلع أحد على هذا، وكثرة العلامات لا تزيد النقاط.',
    'write.showModel': 'اعرض إجابة نموذجية',
    'write.selfScore': 'تصحيحك لنفسك',
    'write.selfScoreSub': 'هذا حكمك أنت لا درجة رسمية. والبنود التي لم تضع عليها علامة هي أهدافك في الكتابة القادمة.',
    'write.model': 'إجابة نموذجية',
    'write.back': 'عودة إلى المهام',
    'write.state.new': 'لم تبدأ',
    'write.state.draft': 'مسودة محفوظة',
    'write.state.done': 'صُحِّحت',
    'unit.write': 'اكتب', 'unit.writeDesc': 'كتابة حرة مع قائمة تحقّق ذاتية',
    'net.offline': 'أنت غير متصل بالإنترنت. الدروس التي فتحتها من قبل ما زالت تعمل.',
    'set.offline': 'الاستخدام دون إنترنت',
    'set.offlineDesc': 'نزّل كل الدروس الآن ليعمل المنهج كاملاً بلا اتصال. أقل من ميغابايت واحد، تُحفظ في هذا المتصفح.',
    'set.offlineGet': 'تنزيل كل الدروس',
    'set.offlineProgress': 'جارٍ التنزيل… {done}/{total}',
    'set.offlineDone': '✓ حُفظت الملفات كلها ({total} ملفاً، {mb} ميغابايت). المنهج يعمل الآن دون إنترنت.',
    'set.offlinePartial': 'حُفظ {ok} من {total} ملفاً. أعد المحاولة عند تحسّن الاتصال.',
